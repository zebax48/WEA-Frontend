  ...
  useEffect(() => {
    ...
    const fetchTickets = async () => {
      try {
        ...
        const cashAppTickets = data.filter((ticket: Ticket) => ticket.paymentType === 'cash');
        setTickets(cashAppTickets);
      } catch (error) {
