  ...
  useEffect(() => {
    ...
    const fetchTickets = async () => {
      try {
        ...
        const moncashTickets = data.filter((ticket: Ticket) => ticket.paymentType === 'moncash');
        setTickets(moncashTickets);
      } catch (error) {
