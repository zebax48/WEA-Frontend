  ...
  useEffect(() => {
    ...
    const fetchTickets = async () => {
      try {
        ...
        const natCashTickets = data.filter((ticket: Ticket) => ticket.paymentType === 'natCash');
        setTickets(natCashTickets);
      } catch (error) {
